...
for i in range(len(x)):
    plt.text(x[i], male_population[i] / 2, str(male_population[i]), ha='center', color='white')
    plt.text(x[i], male_population[i] + (female_population[i] / 2), str(female_population[i]) , ha='center', color='black')
